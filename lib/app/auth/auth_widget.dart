...
class _AuthWidgetState extends ModularState<AuthWidget, AuthBloc> {
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Container(
          ...
          decoration: AppBoxDecorations.rage,
          height: 60.0,
          child: TextField(
  ...
  Widget _buildLoginBtn() {
    return Container(
      ...
      child: RaisedButton(
        elevation: 5.0,
        onPressed: () => print(
            'Login Button Pressed ${controller.emailController.value.text}'),
